"""
Module containing model fitting code that implements a topic model using 
gensim(Choice between LDA, LSI, LDAMallet and HDP).
"""
import numpy as np
import pandas as pd
...
class MyGenSimModel():
    """A gensim based topic model to identify topics:
